...
const byte song[] = {74, 73, 71, 69, 67, 66, 64, 62, 69, 71, 71, 73, 73, 74, 74, 74, 73, 71, 69, 69, 67, 66, 74, 74, 73, 71, 69, 69, 67, 66, 66, 66, 66, 66, 66, 66, 67, 69, 67, 66, 64, 64, 64, 64, 64, 66, 67, 66, 64, 62, 74, 71, 69, 67, 66, 67, 66, 64, 62};
...
void loop() {
  ...
  for (byte x = 0; x < NUMBER_OF_SENSORS; x++) {
    ...
    if (distance[x] > 0 && distance[x] < 400) {
      handleSensorState(x);
    }
  }
  delay(50);
